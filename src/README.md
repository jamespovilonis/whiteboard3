...
- `hooks/useProblemFlowController.js`: problem sequence state, model-shell response text, submit behavior, and stroke reconciliation.
...
- `components/ModelShell.jsx` renders the placeholder model-response shell and submit action.

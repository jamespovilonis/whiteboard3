...
class MathFeedbackServiceTests(unittest.TestCase):
    ...
    def test_llm_error_returns_fallback_with_metadata(self):
        ...
        self.assertNotIn("A good next line is", result["text"])
        self.assertNotIn("Line 2 should be", result["text"])
        self.assertNotIn("Start with:", result["text"])
        self.assertNotIn("Use this line:", result["text"])
